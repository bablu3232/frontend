...
# Fetch latest report
cursor.execute("SELECT id, file_path FROM reports ORDER BY id DESC LIMIT 1")
row = cursor.fetchone()
...
if row:
    ...
    try:
        ...
        if "OCR OUTPUT:" in out:
            ...
            # Verify if Hemoglobin is in JSON
            if "Hemoglobin" in json_text:
                print("SUCCESS: Hemoglobin was successfully extracted!")
            ...
            print("Failed to find OCR OUTPUT in script execution.")
